...
, ORGID BP_AN8, JDE_E58RCI2 MCU_AN8, AGENT_ID EMP_AN8, CUST_NAME NAME
, CUST_TYPE CTG_CODE, CUST_SOURCE SRC_CODE, CUST_LEVEL LVL_CODE, CUST_STATUS STS_CODE
, JDE_ACL CREDIT_AMT/*信用额度*/, JDE_TRAR TERM_CODE/*支付条款*/
, JDE_E58NMCC C1, JDE_E58PT C2, JDE_E58HUS05 C3
, JDE_E58HUS19 INV_TYPE, INV_TITLE, COMP_TAXNO INV_TAXNO
, BANK_NAME INV_BANK_NAME, JDE_E58HUS29 INV_BANK_ACCNO
, COMP_ADDR COMP_REG_ADDR, JDE_E58IMCN COMP_REG_TEL
, JDE_E58RFG4 INV_GTP_FLAG, JDE_E58RFG2 INV_VAT_FLAG
...
, IMPRP1 C1, IMPRP2 C2, IMSRP2 C3, IMSRP1 S1/*UDC=41/S1*/, IMPRGR PG
, IMLNTY LINE_TYPE, IMSTKT INV_STATUS, IMUOM1 UOM, IMUWUM WOM/*重量的主计量单位*/ 
...
from CRPDTA.F4101
inner join CRPDTA.F41021 on LIITM=IMITM and LIMCU like '      18%'
left join CRPDTA.FE64101/*产品扩展属性，没有更新时间无法单独同步*/ on STITM=IMITM@ERP
...
-- and 117224/*today*/ between SINCE_JD and UNTIL_JD
...
-- 
-- 使用方式
-- 按以下顺序执行搜索（且 order by UNTIL_JD asc, JD desc, JT desc），直到找到一条数据。
-- 1. 客户(CUST_AN8)+仓库(MCU_CODE)+料号(ITEM_NO)
-- 2. 客户(CUST_AN8)+仓库(MCU_CODE)+价格组(PG_ID)
-- 3. 仓库(MCU_CODE)+料号(ITEM_NO)
-- 4. 仓库(MCU_CODE)+价格组(PG_ID)
-- 
select
  BPUPMJ JD, BPTDAY JT
, BPAN8 CUST_AN8, BPMCU MCU_CODE, BPITM ITEM_NO, BPIGID PG_ID
